      ...
      <form action="html2.php" method="post">
        <h2>Sample-2</h2><br>
          <p><<s>!DOCTYPE html><br>
              ...
              <<s>h2>HTML Paragraph<<s>/h2><br>
              <<s>p>This is a paragraph.<<s>/p><br>
              <<s>p>This is another paragraph.<<s>/p><br>
              <br>
              <<s>h2>HTML Images</h2><br>
              <<s>p>HTML images are defined with the img tag:<<s>/p><br>
              <br>
              <<s>img src="https://www.educationperfect.com/wp-content/uploads/2022/11/<br>Generic_Happyhighschoolgirlusinglaptopinclassroom_1500px.webp"width="300" height="200"><br>
              <br>
              <<s>/body><br>
              <<s>/html>
        </p>
