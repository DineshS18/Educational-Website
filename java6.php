...
<body>
  ...
  <div class="container">
      <form action="java6.php" method="post">
        <h2>Sample-6</h2>
          <p>import java.io.*;<br>
              import java.util.*;<br>
              ...
              {<br>
                  ...
                  &nbsp{<br>
                &nbsp&nbspint year;<br>
                &nbsp&nbspSystem.out.println("Enter the year");<br>
                &nbsp&nbspSystem.out.println("-----------------------------");<br>
                &nbsp&nbspyear=2004;<br>
                &nbsp&nbspif(year%4==0)<br>
                &nbsp&nbsp{<br>
                    &nbsp&nbsp&nbspSystem.out.println("It is Leap Year");<br>
                &nbsp&nbsp}<br>
                &nbsp&nbspelse<br>
                &nbsp&nbsp{<br>
                    &nbsp&nbsp&nbspSystem.out.println("It is Not a Leap Year");<br>
                &nbsp&nbsp}<br>
                &nbsp}<br>
              }
        </p>
