...
<body>
  ...
  <div class="container">
      <form action="c2.php" method="post">
          ...
          <p>//header files<br>
            ...
            int main()<br>
              {<br>
                ...
                scanf("%d",&b);<br>
                //here defining c as sum<br>
                c=a+b;<br>
                //here defining d as subraction<br>
                d=a-b;<br>
                //here defining e as multiply<br>
                e=a*b;<br>
                //here defining f as division<br>
                f=a/b;<br>
                //here printing those sum,sub,mul,div
                printf("\nAddition of two Numbers are:%d",c);<br>
                printf("\nSubtraction of two Numbers are:%d",d);<br>
                printf("\nMultiplication of two Numbers are:%d",e);<br>
                printf("\nDivision of two Numbers are:%d",f);<br>
                return 0;<br>
              }
        </p>
        <br>
        ...
        <source src="CVideo.ogg" type="video/ogg">
