...
<body>
  ...
  <div class="container">
      <form action="html3.php" method="post">
        <h2>Sample-3</h2><br>
          <p><<s>!DOCTYPE html><br>
              <<s>html><br>
              <<s>body><br>
                <br>
              <<s>h2>HTML Links<<s>/h2><br>
              <<s>p>HTML links are defined with the a tag:<<s>/p><br>
              <br>
              <<s>a href="https://en.wikipedia.org/wiki/Iron_Man">This is a link<<s>/a><br>
              <br>
              <<s>h2>HTML Buttons</h2><br>
              <p>HTML buttons are defined with the button tag:<<s>/p><br>
              <br>
              <<s>button><<s>a href="https://en.wikipedia.org/wiki/Iron_Man">Click me<<s>/a><<s>/button><br>
              <br>
              <<s>/body><br>
              <<s>/html><br>
        </p>
