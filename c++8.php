...
<body>
  ...
  <div class="container">
      <form action="c++8.php" method="post">
        <h2>Sample-8(Class-2)</h2>
          <p>#include<<i>iostream><br>
            ...
            {<br>
              ...
              void getdata()<br>
              {<br>
                cout<<"Enter the First Number:"<<<e>endl;<br>
                cin>>a;<br>
                cout<<"Enter the Second Number:"<<<e>endl;<br>
                cin>>b;<br>
              }<br>
              void display()<br>
              {<br>
                c=a+b;<br>
                cout<<"\nThe Sum of two Numbers are:"<<<e>c<<<e>endl;<br>
              }<br>
            };<br>
            class odd_even<br>
            {<br>
              ...
              void getdata()<br>
              {<br>
                cout<<"Enter the Number:"<<<e>endl;<br>
                cin>>d;<br>
              }<br>
              void display()<br>
              {<br>
    ...
    <div class="sidebar">
      <ul>
        ...
        <li><a href="#"><i class="fas fa-stream"></i>Sample-8</a></li>
      </ul>
    </div>
</body>
</html>