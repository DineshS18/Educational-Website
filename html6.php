...
<body>
  ...
  <div class="container">
      <form action="html6.php" method="post">
        <h2>Sample-6</h2><br>
          <p><<s>!DOCTYPE html><br>
              <<s>html><br>
              <<s>body><br>
               <br> 
              <<s>p>I am normal<<s>/p><br>
              <<s>p style="color:red;">I am red<<s>/p><br>
              <<s>p style="color:blue;">I am blue<<s>/p><br>
              <<s>p style="font-size:50px;">I am big<<s>/p><br>
              <<s>body style="background-color:powderblue;"><br>
              <<s>h1>This is a heading<<s>/h1><br>
              <<s>p>This is a paragraph.<<s>/p><br>
              <<s>h1 style="color:blue;">This is a heading<<s>/h1><br>
              <<s>p style="color:red;">This is a paragraph.<<s>/p><br>
              <<s>h1 style="font-family:verdana;">This is a heading<<s>/h1><br>
              <<s>p style="font-family:courier;">This is a paragraph.<<s>/p><br>
              <<s>h1 style="font-size:300%;">This is a heading<<s>/h1><br>
              <<s>p style="font-size:160%;">This is a paragraph.<<s>/p><br>
              <<s>h1 style="text-align:center;">Centered Heading<<s>/h1><br>
              <<s>p style="text-align:center;">Centered paragraph.<<s>/p><br>
              <br>
              <<s>/body><br>
              <<s>/html><br>
        </p>
