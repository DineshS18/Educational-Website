...
<body>
  ...
  <div class="container">
      <form action="python4.php" method="post">
        <h2>Sample-4</h2><br>
          <p># python 3 program to check whether the given number is armstrong or not without using power function<br>
             # or n=int(input()) -> taking input from user<br>
             print("-----------------------------------")<br>
            print("Checking Amstrong Number")<br>
            print("-----------------------------------")<br>
            n = (int(input("Enter your number:")))<br>
            s = n # assigning input value to the s variable<br>
            b = len(str(n))<br>
            sum1 = 0<br>
            while n != 0:<br>
              &nbsp&nbspr = n % 10<br>
              &nbsp&nbspsum1 = sum1+(r**b)<br>
              &nbsp&nbspn = n//10<br>
            &nbsp&nbspif s == sum1:<br>
              &nbsp&nbsp&nbsp&nbspprint("The given number", s, "is armstrong number")<br>
            &nbsp&nbspelse:<br>
              &nbsp&nbspprint("The given number", s, "is not armstrong number")
        </p>
        <br>
        <br>
        <h2>Output</h2>
