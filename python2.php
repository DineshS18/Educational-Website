...
<body>
  ...
  <div class="container">
      <form action="python2.php" method="post">
        <h2>Sample-2</h2><br>
          <p># Python program to find the maximum and minimum of two numbers<br>
            def maximum(a, b):<br>
              &nbsp&nbsp&nbspif a >= b:<br>
                &nbsp&nbsp&nbsp&nbsp&nbsp&nbspreturn a<br>
              &nbsp&nbsp&nbspelse:<br>
                &nbsp&nbsp&nbsp&nbsp&nbsp&nbspreturn b<br>
            # Driver code<br>
            print("-----------------------------")<br>
            print("Maximum Number")<br>
            print("-----------------------------")<br>
            #User input to find max and min<br>
            a = input("Enter 1st Number:")<br>
            b = input("Enter 2nd Number:")<br>
            print("The Maximum Number is:"+maximum(a, b))<br>
            def minimum(a, b):<br>
              &nbsp&nbsp&nbspif a <= b:<br>
                &nbsp&nbsp&nbsp&nbsp&nbsp&nbspreturn a<br>
              &nbsp&nbsp&nbspelse:<br>
            ...
            # Driver code<br>
            print("-----------------------------")<br>
            print("Minimum Number")<br>
            print("-----------------------------")<br>
            c = input("Enter 1st Number:")<br>
            d = input("Enter 2nd Number:")<br>
            print("The Minimum Number is:"+minimum(c, d))
        </p>
        <br>
        <br>
        <h2>Output</h2>
    ...
    <div class="sidebar">
      <ul>
        ...
        <li><a href="#"><i class="fas fa-stream"></i>Sample-2</a></li>
