...
<body>
  ...
  <div class="container">
      <form action="python5.php" method="post">
        <h2>Sample-5</h2><br>
          <p>#Program to find prime or not<br>
            #Here we getting input verify the Number<br>
            print("-----------------------------------")<br>
            print("Prime Or Not")<br>
            print("-----------------------------------")<br>
            num = int(input("Enter Your Number:"))<br>
            # If given number is greater than 1<br>
            if num > 1:<br>
              # Iterate from 2 to n / 2<br>
              &nbsp&nbspfor i in range(2, int(num/2)+1):<br>
                # If num is divisible by any number between<br>
                # 2 and n / 2, it is not prime<br>
                &nbsp&nbsp&nbsp&nbspif (num % i) == 0:<br>
                  &nbsp&nbsp&nbsp&nbsp&nbsp&nbspprint(num, "is not a prime number")<br>
                  &nbsp&nbsp&nbsp&nbsp&nbsp&nbspbreak<br>
              &nbsp&nbsp&nbsp&nbspelse:<br>
                &nbsp&nbsp&nbsp&nbsp&nbsp&nbspprint(num, "is a prime number")<br>
            &nbsp&nbsp&nbsp&nbspelse:<br>
              &nbsp&nbsp&nbsp&nbsp&nbsp&nbspprint(num, "is not a prime number")
        </p>
        <br>
        <br>
        <h2>Output</h2>
