...
<body>
  ...
  <div class="container">
      <form action="c++7.php" method="post">
        <h2>Sample-7(Class-1)</h2>
          <p>#include<<i>iostream><br>
            ...
            {<br>
              c=a+b;<br>
              cout<<"\nThe Sum of two Numbers are:"<<<e>c;<br>
            }<br>
            int main()<br>
            {<br>
              sample s;<br>
    ...
    <div class="sidebar">
      <ul>
        ...
        <li><a href="#"><i class="fas fa-stream"></i>Sample-7</a></li>
