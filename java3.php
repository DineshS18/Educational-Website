...
<body>
  ...
  <div class="container">
      <form action="java3.php" method="post">
        <h2>Sample-3</h2>
          <p>import java.io.*;<br>
              import java.util.*;<br>
              ...
              {<br>
                ...
                &nbsp&nbspe=a*b;<br>
                &nbsp&nbspf=a/b;<br>
                &nbsp&nbspSystem.out.println("Add value is:"+c);<br>
                &nbsp&nbspSystem.out.println("Sub value is:"+d);<br>
                &nbsp&nbspSystem.out.println("Mul value is:"+e);<br>
                &nbsp&nbspSystem.out.println("Div value is:"+f);<br>
                  &nbsp}<br>
              }
        </p>
        <br>
